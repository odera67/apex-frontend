            ...
            <div className="lg:col-span-7 space-y-8 relative">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-6">
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="overflow-hidden border-primary text-primary hover:bg-primary/10 px-8 py-6 text-lg font-medium transition-colors"
                >
                ...
                <Button
                  ...
                  variant="secondary"
                  asChild
                  className="overflow-hidden bg-muted text-foreground hover:bg-muted/80 border border-border px-8 py-6 text-lg font-medium transition-colors"
                >
                  <Link href={"/check-in"} className="flex items-center font-mono">
